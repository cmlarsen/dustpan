...
const KNOWN: &[Known] = &[
    Known {
        ...
        clean: Clean::Command("pnpm", &["store", "prune"]),
        note: "prune removes packages no project references; frees part of this",
    },
    Known {
        name: "uv cache",
        path: ".cache/uv",
        verdict: Verdict::Safe,
        clean: Clean::Command("uv", &["cache", "prune"]),
        note: "prune removes unused wheels and sources",
    },
    Known {
        name: "Homebrew downloads",
        path: "Library/Caches/Homebrew",
        verdict: Verdict::Review,
        clean: Clean::Command("brew", &["cleanup", "--prune=all"]),
        note: "old bottles and downloads; `brew cleanup --prune=all` also removes old formula versions, which breaks virtualenvs pinned to a Cellar path",
    },
    Known {
        ...
        verdict: Verdict::Safe,
        clean: Clean::Delete,
        note: "pods re-download on the next pod install",
    },
    Known {
        name: "npm cache",
        path: ".npm/_cacache",
        verdict: Verdict::Safe,
        clean: Clean::Delete,
        note: "npm re-downloads on demand",
    },
    Known {
        name: "bun cache",
        ...
        verdict: Verdict::Safe,
        clean: Clean::Delete,
        note: "bun re-downloads on demand",
    },
    Known {
        name: "Yarn cache",
        ...
        verdict: Verdict::Safe,
        clean: Clean::Delete,
        note: "yarn re-downloads on demand",
    },
    Known {
        ...
        verdict: Verdict::Safe,
        clean: Clean::Delete,
        note: "crate archives; cargo re-downloads on demand",
    },
    Known {
        name: "Go build cache",
        ...
        verdict: Verdict::Safe,
        clean: Clean::Delete,
        note: "rebuilt on the next go build",
    },
    Known {
        name: "pip cache",
        ...
        verdict: Verdict::Safe,
        clean: Clean::Delete,
        note: "pip re-downloads on demand",
    },
    Known {
        ...
        verdict: Verdict::Safe,
        clean: Clean::Delete,
        note: "re-downloaded on the next native build",
    },
    Known {
        ...
        verdict: Verdict::Safe,
        clean: Clean::Delete,
        note: "Electron zips cached by electron-builder and friends",
    },
    Known {
        ...
        verdict: Verdict::Safe,
        clean: Clean::Delete,
        note: "dyld and runtime caches; rebuilt on next boot",
    },
    Known {
        name: "Xcode previews",
        ...
        verdict: Verdict::Safe,
        clean: Clean::Delete,
        note: "SwiftUI preview simulators and builds",
    },
    Known {
        name: "XCTest device clones",
        path: "Library/Developer/XCTestDevices",
        verdict: Verdict::Safe,
        clean: Clean::Delete,
        note: "clones left by parallel test runs",
    },
    Known {
        name: "Xcode archives",
        ...
        verdict: Verdict::Review,
        clean: Clean::Delete,
        note: "needed to re-export or symbolicate old builds",
    },
    Known {
        name: "Gradle caches",
        path: ".gradle/caches",
        verdict: Verdict::Review,
        clean: Clean::Delete,
        note: "Android/Gradle dependencies; slow to re-download",
    },
    Known {
        ...
        verdict: Verdict::Review,
        clean: Clean::Delete,
        note: "headless Chrome builds; re-downloaded on the next install",
    },
    Known {
        ...
        verdict: Verdict::Review,
        clean: Clean::Delete,
        note: "browser builds; `npx playwright install` restores them",
    },
    Known {
        ...
        verdict: Verdict::Review,
        clean: Clean::Delete,
        note: "emulator disks and snapshots; recreate them in Android Studio",
    },
    Known {
        ...
        verdict: Verdict::Review,
        clean: Clean::Delete,
        note: "emulator OS images; the SDK Manager downloads them again",
    },
    Known {
        ...
        verdict: Verdict::Review,
        clean: Clean::Delete,
        note: "downloaded models; large to fetch again",
    },
];
...
pub fn recency(
    ...
    match idle_days {
        Some(d) if deletes && verdict == Verdict::Safe && d <= stale_days => (
            Verdict::Review,
            Some(format!(
                "in active use ({d}d ago): deleting it only costs re-download time"
            )),
        ),
        _ => (verdict, None),
    }
                ...
                item.action = match &k.clean {
                    ...
                    Clean::Command(prog, _) => {
                        item.reasons.push(format!(
                            "{prog} is not on PATH, so the folder is deleted instead"
                        ));
                        Action::delete(&path)
                    }
                    Clean::Delete => Action::delete(&path),
                };
                let (verdict, note) = recency(
                    item.verdict,
                    &item.action,
...
mod tests {
    ...
    fn recently_used_delete_caches_need_review_but_prunes_stay_safe() {
        ...
        assert_eq!(
            recency(Verdict::Review, &del, Some(1), 30),
            (Verdict::Review, None)
        );
    }
    ...
    fn brew_cleanup_is_review_because_it_drops_old_formula_versions() {
        let brew = KNOWN
            .iter()
            .find(|k| k.path == "Library/Caches/Homebrew")
            .unwrap();
